...
class ForestClassifier(ClassifierMixin, BaseEstimator):
    def __init__(self, n_estimators=100, use_idf=True, analyzer=stemmed_words, chi_portion=0.5):
...
if __name__ == "__main__":
    ...
    if not LOAD_MODEL:
        ...
        print(f"\n=== Best model's params:\n {clf.best_params_}\n")
        joblib.dump(model, 'random_forest_classifier.sav')
    else:
        model = joblib.load('random_forest_classifier.sav')
